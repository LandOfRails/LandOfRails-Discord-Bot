...
public class CommandAFK implements Command, Aliases {
    ...
    public void onCall(MessageReceivedEvent event) {
        ...
        if (afkPlayers.containsKey(id)) {
            ...
            channel.sendMessageEmbeds(builder.build()).queue(success -> success.delete().queueAfter(10, TimeUnit.SECONDS));
    ...
    public void onMessageEvent(MessageReceivedEvent event) {
        ...
        for (IMentionable mention : mentions) {
            ...
            if (afkPlayers.containsKey(id) && !event.getAuthor().isBot()) {
                ...
                event.getMessage().replyEmbeds(eb.build()).queue(success -> success.delete().queueAfter(15, TimeUnit.SECONDS));
            }
        }
    ...
    /**
     * Gibt die hoechsten zwei Zeiteinheiten zurueck
